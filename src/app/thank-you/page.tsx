		...
		<main className='relative lg:min-h-full'>
			<div className='hidden lg:block overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12'>
				<Image
					...
					sizes='(max-width:1200) 600px (min-width:1201)800'
					priority
				/>
			</div>
			<div>
												...
												<div className='relative h-24 w-24'>
													...
													image.url ? (
														<Image
															...
															sizes='(max-width:767px) 300px (min-width:1200px) 400px'
															className='flex rounded-md bg-gray-100 object-cover object-center'
														/>
													) : null}
												</div>
