            ...
            switch (_d.label) {
                case 0:
                    ...
                    if (cachedPayload.client) {
                        return [2 /*return*/, cachedPayload.client];
                    }
                    if (!cachedPayload.promise) {
                        cachedPayload.promise = payload_1.default.init(__assign({ email: {
                                transport: transporter,
                                fromAddress: "onboarding@resend.dev",
                                fromName: "Hoda Salah",
                            }, secret: process.env.PAYLOAD_SECRET, local: initOptions && (initOptions === null || initOptions === void 0 ? void 0 : initOptions.express) ? false : true }, (initOptions || {})));
                    }
                    _d.label = 1;
                case 1:
                    _d.trys.push([1, 3, , 4]);
                    _c = cachedPayload;
                    return [4 /*yield*/, cachedPayload.promise];
                case 2:
                    _c.client = _d.sent();
                    return [3 /*break*/, 4];
                case 3:
                    ...
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/, cachedPayload.client];
            }
        });
    });
};
